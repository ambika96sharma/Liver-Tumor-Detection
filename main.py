...
def upload_file():
    if request.method == "POST":
        ...
        if ctf == "":
            ...
            fl.writelines(lines)
            fl.close()
            filepath = generate_results()
            #return render_template('uploaded_file.html', image_name="C:/Users/allen/flaskproject/"+filepath)
            return render_template('uploaded_file.html', image_name="C:/Users/allen/flaskproject/res.jpeg")
...
def generate_results():
    ...
    if (GENERATE_JPG_FILES):
        ...
        for index, line in enumerate(lines):
            if index == 0:
                ...
                ctf = "C:/Users/allen/flaskproject/" + ctf[:-6]
                segvar = "C:/Users/allen/flaskproject/" + line.strip().split("=")[2]
        path = Path(".")
    ...
    learn0 = load_learner("C:/Users/allen/flaskproject/Liver_segmentation", cpu=False)
    ...
    plt.imshow(predicted_mask[0], cmap='bone')
    plt.imshow(predicted_mask[0], alpha=0.5, cmap="nipy_spectral")
    #save_image(predicted_mask[0],"result_"+ctf.split(".")[0]+".jpg")
    plt.imsave("result_"+ctf.split("/")[4].split(".")[0]+".png",predicted_mask[0])
    return "result_"+ctf.split("/")[4].split(".")[0]+".png"
